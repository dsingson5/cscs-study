...
if (!window.SAEngine) {
  ...
  window.SAEngine = {
    ...
    _build3D: function (THREE, host, frames, pal, ink) {
      ...
      // bar runs ACROSS the athlete (Z axis) -- perpendicular to the sagittal plane
      ...
      var rotY = 0.6, rotX = 0.04, down = false, lx = 0, ly = 0;
      ...
      var stopped = false, clock = 0, last = performance.now(), drew = false;
